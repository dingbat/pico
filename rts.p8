	 ...
	 for y=cy\8,cy\8+16 do
	 	if not g(vizmap,x,y) then
	 		camera(x*-8+cx,y*-8+cy)
				fillp(▒)
				--make it so the … doesn't
				--draw on already-black px
				poke(0x5f5e,158)
				rect(unspl"-1,-1,8,8,5")
				poke(0x5f5e,255)
...
--				function border(dx,dy,largs)
--					if g(vizmap,x+dx,y+dy) then
--						line(unspl(largs))
--					end
--				end
--				border(-1,0,"-1,0,-1,7")
...
__map__

