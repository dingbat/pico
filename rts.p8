...
function tick_unit(u)
	...
	if u.p==1 or u.st.t=="attack" and not u.st.wayp then
		...
		local cache=vcache[los]
		if not cache then
			cache={}
			vcache[los]=cache
		end
		local viz=g(cache,u.x\4,u.y\4)
		if not viz then
			viz={}
			printh("computing viz","log")
			for t in all_surr(
				u.x\fogtile,
				u.y\fogtile,
				ceil(los/fogtile)
...

...

...

