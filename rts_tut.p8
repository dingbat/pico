...
--	rectfill(0,0,128,30,0)
	...
	if c==2 then
		local dx,dy=0,0
		if (btn(⬅️) or btn(⬅️,1)) dx=-1
		if (btn(➡️) or btn(➡️,1)) dx=1
		if (btn(⬆️) or btn(⬆️,1)) dy=-1
		if (btn(⬇️) or btn(⬇️,1)) dy=1
		spr(234,108,1,2,2)
	...
	if moving and t()-moving>1.5 then
		moved=true
	end
	lc,llc=
		llc and not btn"4",
	...
	if sel1 and sel1.typ.queen and
		sel1.rx then
		if not rallyt then
			rallyt=t()
		elseif t()-rallyt>3 then
			rallied=true
		end
	end
	local w=units[9]
...
--	done=false
	if done then
		?"\^tgood luck, and",11
		?"\^whave fun!"
	elseif sel1 and sel1.typ.idx==9 then
		?"mounds also serve"
		?"as drop-offs for"
		?"all resource types"
...
--			res1.r=100
			...
			elseif rallied then
				...
				?"on a resource"
			elseif sel1.q.qty>=2 and res1.p>=8 then
				if c==3 then
					?"\f9right-click\f7 to"
	...
	elseif nsel==3 and moved then
		...
		elseif c==1 then
			if (axn or sel1.st.t=="gth") color(6)
			?"with worker ants selected,"
			?"tap the action button,"
			if axn or sel1.st.t=="gth" then
				color(7)
				?"then tap a resource to"
				?"begin gathering it"
			end
		end
	elseif nsel==3 and not moved then
		if c==3 then
		...
		elseif c==2 then
			...
			?"selected units"
		elseif c==1 then
			if (axn or moving) color(6)
			?"with units selected,"
			?"tap the action button,"
			if axn or moving then
				color(7)
...

...

...

__label__
...
__gff__

...
__map__

...

...

...

...

...

...

...

...

__sfx__
