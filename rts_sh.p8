...
conv=0
alive=1
bop=101]],_typ[_p],rnd"60"\1))foreach(split"w8,h8,bldg,unit,farm,idx,qn,web,ant,mnk,w,h,atk,def,drop,sp,sg,bldrs,bmap,hpr",function(k)_ENV[k]=typ[k]end)max_hp=_const and _const>0and _const*hpr or typ.hp id,x,y,p,hp,const,disc,prod=x,_x,_y,_p,min(_hp or 9999,max_hp),max(_const)>0and _const,_disc==1,_typ.prod or{}end tot+=1rest(box(u))if u.bldg then reg_bldg(u)end return u end function prod(u,b,m)pay(b,1,u.pres)u.q=u.q or p("qty=0",b,b.t*m)u.q.qty+=1end p[[var=f2r
7=r
10=g
11=g
19=b
