...
end end function path(u,x,y,tol,r)if u.unit then spdr,dest,dest_d=u.spider,nearest(x,y)wayp,e,spdr=as(nearest(u.x,u.y),dest,r)if e and not r and dest_d<=(tol or 1)then deli(wayp)add(wayp,{x,y})end return#wayp>0and wayp end end function as(st,g,d)local gk,t=g.k>>16,{[st.k]=p([[var=sh
y=0
